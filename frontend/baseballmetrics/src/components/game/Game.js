		...
		switch (outs) {
			case 0:
				return (
					<div>
						<p>무사 상황입니다.</p>
						<p>1. 주자없음: 출루가 중요합니다! 출루율이 높은 타자가 유리합니다.</p>
						<p>2. 1루: 큰 점수를 노리고 싶다면, 장타율이 높은 타자를 쓰는 것을 추천합니다. 번트를 통해 주자를 득점권으로 진루시키는 것도 좋은 방법입니다.</p>
						<p>3. 득점권: 점수를 내고 싶다면 무사이므로 어떻게든 inplay 타구를 만들어내야 합니다. 타율, BB/K가 높은 타자를 쓰세요!</p>
						<p>큰 한방을 노리기 위해서 장타율이 높은 선수는 언제든지 환영입니다.</p>
					</div>
				);
			case 1:
				return (
					<div>
						...
						<p>3. 득점권: 1루 주자가 없다면 타율이 높은 타자를 쓰는 것도 좋은 방법입니다! 점수를 많이 내고 싶다면, 장타율이 높고 홈런이 많은 파워를 갖춘 타자를 써보세요!</p>
					</div>
				);
			case 2:
				return (
					<div>
						<p>2사 상황입니다.</p>
						<p>1. 주자 없음: 기회가 많이 없으므로 장타율이 높아 큰거 한방을 만들어내야 합니다.</p>
